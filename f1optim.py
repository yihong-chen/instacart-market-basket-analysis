...
# results = pool.map(optim, [list goes here] )

# The format of the data that I give to this function is a little different from that of the kernel. I pass a list of tuples where each contains (user, list of probabilities, none probability). I return user, best_k, predNone from the function. You can vary it as per your requirement.